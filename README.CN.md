...
2. <kbd>shift</kbd>+<kbd>command</kbd>+<kbd>B</kbd> 呼出编译控制； <p align="center"><img src="./README.file/compile.png" alt="compile" width="400"/></p> 
3. 选择 `LaTeX-XeLaTeX` 选项进行编译；  
4. 编译成功后自动弹出 Skim界面，将它们放在一起，如下： <p align="center"><img src="./README.file/Sublime_text_Skim.png" alt="Sublime_text_Skim" width="900"/></p> 
...
```
2. 渲染结束后，生成两个显示屏幕：
<p align="center"><img src="./README.file/audience1.png" alt="audience" width="500"/></p>
<p align="center"> "Audience Screen"
<p align="center"><img src="./README.file/presenter1.png" alt="presenter" width="500"/></p>
3.两个屏幕同步显示。演示者显示,包括下一张幻灯片,已用时间，备注等。
<p align="center"> "Presenter Screen"
<p align="center"><img src="./README.file/presenter2.png" alt="presenter" width="500"/></p>
<p align="center"> "Presenter Screen"  
     
4.演讲者备注通过在.tex文件中使用`\pnote{}`来产生，最终会显示在演示者屏幕的右下角（通过<kbd>command</kbd>+<kbd>+/—</kbd>调节字体大小），如：
<p align="center"><img src="./README.file/presenter3.png" alt="pnote" width="500"/></p>
